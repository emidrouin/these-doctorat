...
<!-- / ICI -->
En tant qu’acte qui introduit, pour mener à bien le passage de langue à énonciation <!--vérifier source et si besoin de citer, [@Benveniste1974, 81-82]--> le « locuteur » au sein de l’« instance de discours » <!-- vérifier source [@Benveniste1966, 263] ou [@Benveniste1974, 81-82]-->, l’énonciation se retrouve ainsi à permettre la construction et le maintien de la subjectivité, car « [c]’est en s’identifiant comme personne unique prononçant *je* que chacun des locuteurs se pose tour à tour comme ‘sujet’ » [@Benveniste1966, 254].
La situation est donc celle d’une « appropriation », disait Benveniste, mais aussi d’une « allocution » dès lors qu’en « se déclar[ant] locuteur et assum[ant] la langue », le locuteur « implante l’*autre* en face de lui, quel que soit le degré de présence qu’il attribue à cet autre. Toute énonciation est, explicite ou implicite, une allocution, elle postule un allocutaire. » [@Benveniste1974, 82], de même qu’un système commun de références – ou un « rapport au monde » partagé –, [(lesquelles font partie de l’énonciation)] [@Benveniste1974, 82] <!-- vérifier source -->.
En d’autres termes – plus ricœuriens –, l’énonciation implique subjectivité et intersubjectivité.
...
Ainsi, nous dit Benveniste nuançant la distinction *langue*/*parole* <!-- vérifier: À CONFIRMER?-->, le *langage* n’est pas en tant que tel un instrument; ce qui est instrument, ou véhicule, c’est la parole en tant qu’elle « assure la ‘communication’ » par sa façon d’être une actualisation du langage [@Benveniste1966, 259].
...
[^4]: Roman Jakobson parlait plutôt de « shifters »<!-- vérifier source -->, que l’on traduit en français par « embrayeurs » du discours [@Kerbrat-Orecchioni1980, 39].
