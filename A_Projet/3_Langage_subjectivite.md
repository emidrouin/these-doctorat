...
[^8]: Ce choix se situe, au sens de la linguistique structurale, à l’intersection entre l’axe syntagmatique (celui du « syntagme », à savoir de la phrase ou du groupe de mots) et l’axe paradigmatique (celui du « paradigme », à savoir des termes qui peuvent se substituer au terme employé). Ainsi, selon Roman Jakobson, la fonction poétique – celle qui s’intéresse autant à la forme qu’au fond du message – « projette le principe d'équivalence de l'axe de la sélection sur l'axe de la combinaison » [@Jakobson1963, 220] <!-- à vérifier -->.
